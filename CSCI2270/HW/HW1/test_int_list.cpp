...
int main()
{
    ...
    //const_head_ptr1 = head_ptr1;
    //print_list(const_head_ptr1);
    //copy_list(const_head_ptr1, head_ptr2); 
    ...
    {
        add_node(head_ptr1, k);	// add a number to the list
        const_head_ptr1 = head_ptr1;
        print_list(const_head_ptr1);
        if (!check_list(const_head_ptr1))
            cout << "List is out of order!" << endl;
    }
    cout << "Done Constructing List" <<endl;
    const_head_ptr1 = head_ptr1;
    print_list(const_head_ptr1);
    clear_list(head_ptr1);
    cout << "list cleared" <<endl;
    const_head_ptr1 = head_ptr1;
    print_list(const_head_ptr1);
    add_node(head_ptr1,1);
    cout << "list with 1 added" <<endl;
    const_head_ptr1 = head_ptr1;
    print_list(const_head_ptr1);
